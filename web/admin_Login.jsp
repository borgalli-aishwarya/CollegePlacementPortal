<%-- 
    ...
    Created on : 2 Aug, 2026, 2:06:24 PM
    Author     : Aishwarya
--%>
...
<li class="nav-item ms-3"><a class="btn btn-light" href="adminRegister.jsp">Register</a></li>
</ul></div></div></nav>
...
<h1>Admin Portal</h1>
<p class="mt-3 fs-5">Manage the entire placement system with full control.</p>
<ul class="mt-4">
<li><i class="fa-solid fa-circle-check"></i>Approve Recruiter Accounts</li>
<li><i class="fa-solid fa-circle-check"></i>Manage Student Records</li>
<li><i class="fa-solid fa-circle-check"></i>Monitor Job Postings</li>
<li><i class="fa-solid fa-circle-check"></i>Generate Reports</li>
</ul>
</div>
...
<p class="text-center mt-3">Don’t have an account? <a href="adminRegister.jsp">Register Here</a></p>
</form>
</div>
</div>
</div>
...
<p>Empowering admins to oversee campus placements.</p>
