<%-- 
    Document   : viewApplicationsRecruiter.jsp
    Created on : 2 Aug, 2026, 3:42:50 PM
    Author     : Aishwarya
--%>
...
<div class="container mt-5 flex-grow-1">
  <h2 class="text-center text-primary mb-4">Student Applications</h2>
  <div class="d-flex justify-content-center">
    <div class="row g-4" style="max-width:900px;">
      <div class="col-md-6">
        <div class="card p-3">
          <h5>Software Engineer</h5>
          <p class="text-muted">Applicant: Aishwarya | Status: Pending</p>
          <div class="d-flex justify-content-between">
            <a href="viewResume.jsp?appId=1" class="btn btn-info btn-sm">View Resume</a>
            <a href="shortlist.jsp?appId=1" class="btn btn-success btn-sm">Shortlist</a>
          </div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="card p-3">
          ...
          <p class="text-muted">Applicant: Rahul | Status: Shortlisted</p>
          <div class="d-flex justify-content-between">
            <a href="viewResume.jsp?appId=2" class="btn btn-info btn-sm">View Resume</a>
            <a href="reject.jsp?appId=2" class="btn btn-danger btn-sm">Reject</a>
          </div>
        </div>
      </div>
    </div>
